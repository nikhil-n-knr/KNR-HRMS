...
watch(() => form.start_date, (newVal) => {
    if (form.end_date && newVal && new Date(form.end_date) < new Date(newVal)) {
...
const formatDate = (dateString) => {
    ...
    return new Date(cleanDate).toLocaleDateString(undefined, { 
        month: 'short', 
        day: 'numeric', 
        year: 'numeric' 
    });
            ...
            <div class="divide-y divide-gray-100">
                ...
                >
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-0.5">{{ formatDate(leave.start_date) }} - {{ formatDate(leave.end_date) }}</p>
