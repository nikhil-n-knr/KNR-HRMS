    ...
    <div class="bg-white rounded-[3rem] p-12 border border-slate-100 shadow-xl shadow-slate-200/30">
        <div class="flex justify-between items-center mb-10">
            ...
            <div class="flex gap-2">
                <button @click="generate('pdf')" :disabled="processing" class="flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white rounded-xl text-sm font-black uppercase tracking-widest hover:bg-indigo-500 transition-all disabled:opacity-50 shadow-lg shadow-indigo-200">
                    <DocumentArrowDownIcon class="w-4 h-4" />
                    Export PDF
                </button>
                <button @click="generate('csv')" :disabled="processing" class="flex items-center gap-2 px-6 py-3 bg-white border border-slate-200 text-slate-900 rounded-xl text-sm font-black uppercase tracking-widest hover:bg-slate-50 transition-all disabled:opacity-50 shadow-sm">
