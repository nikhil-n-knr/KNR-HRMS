                    ...
                    <BaseDataTable :rows="filteredProjects" :columns="columns" selectable>
                        ...
                        <template #cell-actions="{ row }">
                             <div class="flex items-center justify-end gap-2">
                                ...
                                <button @click="viewGovernanceVault(row.id)" class="px-4 py-2 bg-emerald-50 text-emerald-600 text-[9px] font-black uppercase tracking-widest rounded-xl hover:bg-emerald-600 hover:text-white transition-all border border-emerald-100 shadow-sm">
                                    Governance Vault
                                </button>
                             </div>
                        </template>
...
const viewGovernanceVault = (id) => {
    router.get(route('projects.portal.management.governance.deep-dive', id));
};
