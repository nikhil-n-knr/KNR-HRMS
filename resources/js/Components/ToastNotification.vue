  ...
  <div class="fixed top-5 right-5 z-[100] flex flex-col gap-3 pointer-events-none">
    ...
    >
      <div 
        ...
        :key="toast.id" 
        class="max-w-sm w-full bg-white/90 backdrop-blur-xl shadow-xl rounded-xl pointer-events-auto border border-white/50 overflow-hidden transform transition-all hover:scale-[1.02]"
        :class="{
