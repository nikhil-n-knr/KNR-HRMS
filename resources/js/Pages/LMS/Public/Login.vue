<template>
    <div class="min-h-screen bg-[#F0F7F4] font-['Outfit'] flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div class="w-full max-w-5xl bg-white/70 backdrop-blur-xl border border-white rounded-[40px] shadow-2xl shadow-emerald-900/5 overflow-hidden flex flex-col md:flex-row min-h-[700px]">
            ...
            <!-- Left Side: Branding & Info (Same as Register) -->
            <div class="w-full md:w-1/2 bg-gradient-to-br from-emerald-600 to-teal-700 p-12 text-white flex flex-col justify-between relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <h1 class="text-5xl font-black leading-[1.1] mb-6">
                        Welcome <br/>
                        <span class="text-emerald-200">Back</span> <br/>
                        Learner.
                    </h1>
                    <p class="text-emerald-50/70 text-lg max-w-md leading-relaxed">
                        Sign in to resume your curriculum and access your personalized learning matrix.
                    </p>
                </div>

                <div class="relative z-10">
                    <div class="p-6 bg-white/10 backdrop-blur-md rounded-3xl border border-white/10 mb-8">
                        <div class="flex items-center gap-4 mb-4">
                            <div class="w-10 h-10 bg-emerald-400 rounded-full flex items-center justify-center text-emerald-900">
                                <i class="fas fa-quote-left"></i>
                            </div>
                            <span class="text-sm font-bold uppercase tracking-widest text-emerald-100">Daily Insight</span>
                        </div>
                        <p class="text-emerald-50 font-medium italic">"The beautiful thing about learning is that no one can take it away from you."</p>
                        <p class="text-emerald-200/60 text-xs mt-2">— B.B. King</p>
                    </div>
            ...
            <div class="w-full md:w-1/2 p-12 md:p-20 flex flex-col justify-center bg-white/40">
                <div class="max-w-md mx-auto w-full">
                    <div class="mb-10">
                        ...
                        <p class="text-gray-500 font-medium">New student? <Link :href="route('lms.store.register')" class="text-emerald-600 hover:text-emerald-700 font-bold transition-colors">Create account</Link></p>
                    </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center justify-between ml-1">
                                <label class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Password</label>
                                <Link :href="route('lms.store.password.request')" class="text-[9px] font-black text-emerald-600 uppercase tracking-widest hover:text-emerald-700 transition-colors">Forgot Password?</Link>
                            </div>
                            <div class="relative group mt-1">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        ...
                        <div class="flex items-center gap-3 py-2">
                            <input v-model="form.remember" type="checkbox" id="remember" class="w-5 h-5 rounded-lg border-gray-200 text-emerald-600 focus:ring-emerald-500 transition-all cursor-pointer">
                            <label for="remember" class="text-sm font-medium text-gray-500 select-none cursor-pointer">Trust this device for 30 days</label>
                        </div>
                        ...
                        <div class="relative my-8">
                            ...
                            <div class="relative flex justify-center text-xs uppercase font-black tracking-widest">
                                <span class="bg-white/40 px-4 text-gray-400 italic">or continue with</span>
                            </div>
                        </div>
...
const submit = () => {
    form.post(route('lms.store.login.post'), {
