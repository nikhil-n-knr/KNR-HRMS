<template>
  <component :is="embedded ? 'div' : AttendanceLayout" title="Organizational Intelligence Matrix" :activeTab="activeTab || 'analytics'" @update:activeTab="handleTabChange" v-bind="$props">
