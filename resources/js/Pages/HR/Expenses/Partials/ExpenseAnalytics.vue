...
<template>
    ...
    <div v-else class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
             <div class="bg-white p-6 rounded-lg border border-gray-100 shadow-sm relative overflow-hidden">
                <div class="absolute right-0 top-0 h-full w-1 bg-blue-500"></div>
                <p class="text-xs font-semibold text-gray-500 uppercase tracking-widest">Claims (This Month)</p>
                <div class="mt-2 text-2xl font-bold text-gray-900">{{ formatCurrency(metrics.total_claims_this_month) }}</div>
             ...
             <div class="bg-white p-6 rounded-lg border border-gray-100 shadow-sm relative overflow-hidden">
                ...
                <div class="mt-2 text-2xl font-bold text-gray-900">{{ formatCurrency(metrics.outstanding_liability) }}</div>
             ...
             <div class="bg-white p-6 rounded-lg border border-gray-100 shadow-sm relative overflow-hidden">
                ...
                <div class="mt-2 text-2xl font-bold text-gray-900">{{ formatCurrency(metrics.total_rejected_amount) }}</div>
             ...
             <div class="bg-white p-6 rounded-lg border border-gray-100 shadow-sm relative overflow-hidden">
                ...
                <div class="mt-2 text-2xl font-bold text-gray-900">{{ Math.round(metrics.avg_claim_days) }} Days</div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <!-- Pie Chart Mock -->
            <div class="bg-white p-6 rounded-lg border border-gray-100 shadow-sm col-span-2">
