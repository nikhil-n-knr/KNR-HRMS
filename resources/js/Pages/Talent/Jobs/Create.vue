            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Create New Job</h3>
                    ...
                    <form @submit.prevent="submit">
                        <div class="shadow sm:rounded-md sm:overflow-hidden backdrop-blur-xl bg-white/80">
                            <div class="px-4 py-5 space-y-6 sm:p-6">
                                ...
                                <!-- Job ID (Read Only) -->
                                <div>
                                    <InputLabel value="Job Code (Auto-Generated)" />
                                    <TextInput :model-value="nextId" title="Auto-generated" disabled class="mt-1 block w-full bg-gray-100 cursor-not-allowed" />
                                </div>
                            ...
                            <div class="px-4 py-3 bg-gray-50/50 text-right sm:px-6">
                                <Link :href="route('talent.hub')" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mr-3">
                                    Cancel
                                </Link>
...
const submit = () => {
    form.post(route('talent.jobs.store'));
};
</script>
