        ...
        <section class="px-8 mb-10 space-y-6">
            <div class="rounded-3xl border border-indigo-100 bg-gradient-to-r from-indigo-50 via-white to-cyan-50 p-5 lg:p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
                    ...
                    <a :href="opsLaunchers.devops_global_url" class="rounded-2xl border border-slate-200 bg-white px-4 py-3 hover:border-emerald-300 transition-colors">
...
const devopsTrendSeries = computed(() => props.team_insights?.devops_pulse_trend || []);
